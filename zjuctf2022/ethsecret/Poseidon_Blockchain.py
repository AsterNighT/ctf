...
class Account():
    def __init__(self, Chain: Chain, PrivateKey: str) -> None:
        try:
            ...
            # print(self.Net.eth.get_transaction_count(self.Address))
...
class Contract():
    ...
    def CallFunction(self, FunctionName: str, *FunctionArguments) -> tuple:
        ...
        TransactionResult = self.Account.SendTransaction(self.Address, TransactionData["data"], TransactionData["value"], 400000)
